(function () {
    ...
    function initPlayer(element, info, eq) {
        ...
        audio.id = element.substring(1) + "__file";

        createPlayer(inPlayer, info);
        allPlayers.push(new player(inPlayer, eq));
        allPlayersAudio.push(allPlayers[playersLength]);
        allPlayers[playersLength]._init();
        // console.log(allPlayersAudio);
    }
    window.allPlayersArray = allPlayersAudio;
    ...
    function createPlayer(el, info) {
        ...
        var plr = '<div style="background-image: url(' + info.imageSrc + '); background-color: '+ info.color1 +'" class="podcast__cover">\
                                    ...
                                    <div class="podcast__time time">\
                                        ...
                                        <div class="time__line" style="background-color: '+ info.color3 +'">\
                                            <div class="line__current" style="background-color: '+ info.color1 +'"></div>\
                                        </div>\
                                    </div>\
                                </div>\
                                <div class="podcast__meta">\
                                    ...
                                    <div class="podcast__text">\
                                        <h4 class="podcast__title">' + info.title + '</h4>\
                                        <p class="podcast__desc" style="color: '+ info.color1 +'">' + info.description + '</p>\
                                    </div>\
                                </div>';
